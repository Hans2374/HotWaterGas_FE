...
export const SearchResultsPage = () => {
  ...
  useEffect(() => {
    ...
    // console.log('[SearchFilters] Initialized from URL:', {
    //   q: searchParams.get('q') || '',
    //   page: parsedPage,
    //   sortBy: searchParams.get('sort') || 'name',
    //   sortDirection: searchParams.get('direction') || 'asc',
    //   ...parsedFilters
    // });
    ...
    const fetchSearchResults = async () => {
      ...
      try {
        const requestFilters = {
          ...
          // include `tags` shape as well for compatibility with the API client
          tags: filters.tags
        };

        // eslint-disable-next-line no-console
        // console.log('[SearchProducts] Fetch params:', {
        //   page: currentPage,
        ...
        <div className="search-results-layout">
          <aside className="search-filters-panel">
            ...
            <div className="search-filter-group">
              ...
              <div className="search-filter-group">
                <h4 className="search-filter-group-title">Thẻ</h4>
