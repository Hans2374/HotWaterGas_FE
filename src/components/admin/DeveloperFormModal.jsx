...
export const DeveloperFormModal = ({
  ...
  const modalTitle = isEdit ? 'Edit Developer' : 'Create Developer';
  const modalSubtitle = isEdit ? 'Update developer information.' : 'Add a new developer.';
  const submitLabel = isSubmitting ? 'Saving...' : isEdit ? 'Save Changes' : 'Create';

  return (
    <div className="modal-overlay" role="presentation" onClick={onClose}>
      <div
        className="modal-card developer-form-modal"
        role="dialog"
        aria-modal="true"
        ...
        <form onSubmit={handleSubmit}>
          <div className="modal-body">
            ...
            <div className="form-field-group">
              ...
              {formData.logoUrl ? (
                <div className="developer-image-preview">
                  <img
                    src={formData.logoUrl}
                    alt={formData.name || 'Developer'}
                    className="developer-image-thumb"
                  />
                  <button
                    type="button"
                    className="developer-image-remove"
                ...
                <div
                  className={`developer-image-upload-area ${isUploadingImage ? 'uploading' : ''}`}
                ...
                >
                  ...
                  />
                  {isUploadingImage ? (
                    <span className="developer-image-upload-hint">Uploading...</span>
                  ) : (
                    <>
                      <Upload size={18} className="developer-image-upload-icon" />
                      <span className="developer-image-upload-hint">
            ...
            {/* Slug */}
            <div className="form-field-group">
              <label htmlFor="developer-slug" className="input-label">
            ...
            {/* Description */}
            <div className="form-field-group">
              <label htmlFor="developer-description" className="input-label">
